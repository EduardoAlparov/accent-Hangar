export default () => {
  const articlesTitles = document.querySelectorAll('.article-section__container > section > div > article > h2');
  const links = document.querySelectorAll('.article-section__container > section > nav  a');
